...
class Sms {
    ...
    async send({ phone, message }) {
        try {
            ...
            return {
                error: true,
                message: error.response.data.message, // xato chiqyapti
...
export default new Sms({
    login: 'ahmadjonovakmal079@gmail.com',
    password: 'CZYJvcss4F7gq5n0U5ChOMlRfVmdNZISz1Ixm1eF',
    webhookurl: () => console.log('Keldi'),
});
